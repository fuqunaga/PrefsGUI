...
{
    [Serializable]
    public class PrefsMinMaxInt : PrefsMinMax<int, MinMaxInt>
    {
    ...
    [Serializable]
    public class PrefsMinMaxFloat : PrefsMinMax<float, MinMaxFloat>
    {
    ...
    [Serializable]
    public class PrefsMinMaxVector2 : PrefsMinMaxVector<Vector2, MinMaxVector2>
    {
    ...
    [Serializable]
    public class PrefsMinMaxVector3 : PrefsMinMaxVector<Vector3, MinMaxVector3>
    {
    ...
    [Serializable]
    public class PrefsMinMaxVector4 : PrefsMinMaxVector<Vector4, MinMaxVector4>
    {
    ...
    [Serializable]
    public class PrefsMinMaxVector2Int : PrefsMinMaxVector<Vector2Int, MinMaxVector2Int>
    {
    ...
    [Serializable]
    public class PrefsMinMaxVector3Int : PrefsMinMaxVector<Vector3Int, MinMaxVector3Int>
    {
